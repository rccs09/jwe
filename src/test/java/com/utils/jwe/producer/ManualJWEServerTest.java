...
import com.utils.jwe.server.ManualJWEServer;

public class ManualJWEServerTest {
	...
	public void decryptCiphertextWithNimbusTest() {
		...
		try {
			String mensaje = ManualJWEServer.decript(tokenNimbus);
	...
	public void decryptCiphertextManuallyTest() {
        ...
        //decifro token manual
		try {
			String mensaje = ManualJWEServer.decript(tokenManual);
	        System.out.println("=== Payload descifrado ===");
	        System.out.println(mensaje);
		} catch (Exception e) {
			fail("Not yet implemented");
